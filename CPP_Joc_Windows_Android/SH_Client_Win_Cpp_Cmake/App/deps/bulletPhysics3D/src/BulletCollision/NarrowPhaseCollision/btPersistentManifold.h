...
public:
	...
	virtual ~btPersistentManifold() {};//asd_customChange; (+)
	...
	//asd_customChange; void setBodies(const btCollisionObject* body0, const btCollisionObject* body1)
	virtual void setBodies(const btCollisionObject* body0, const btCollisionObject* body1)
	{
		m_body0 = body0;
		m_body1 = body1;
	}
	...
	//asd_customChange; void setNumContacts(int cachedPoints)
	virtual void setNumContacts(int cachedPoints)
	{
	...
	//asd_customChange; int addManifoldPoint(const btManifoldPoint& newPoint, bool isPredictive = false);
	virtual int addManifoldPoint(const btManifoldPoint& newPoint, bool isPredictive = false);

	//asd_customChange; void removeContactPoint(int index)
	virtual void removeContactPoint(int index)
	{
...
#define MAINTAIN_PERSISTENCY 1
	...
	//asd_customChange; SIMD_FORCE_INLINE void clearManifold()
	SIMD_FORCE_INLINE virtual void clearManifold()
	{
		int i;
	...
	//asd_customChange; void deSerialize(const struct btPersistentManifoldDoubleData* manifoldDataPtr);
	virtual void deSerialize(const struct btPersistentManifoldDoubleData* manifoldDataPtr);
	//asd_customChange; void deSerialize(const struct btPersistentManifoldFloatData* manifoldDataPtr);
	virtual void deSerialize(const struct btPersistentManifoldFloatData* manifoldDataPtr);
};
