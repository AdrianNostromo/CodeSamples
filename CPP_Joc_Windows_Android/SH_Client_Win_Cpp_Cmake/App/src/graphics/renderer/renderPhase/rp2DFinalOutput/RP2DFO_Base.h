...
namespace graphics {
class RP2DFO_Base : public RenderPhase, public virtual IRenderPhase2DFinalOutput {priv typedef RenderPhase super;pub dCtor(RP2DFO_Base);
