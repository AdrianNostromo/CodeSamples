#include "Templates_Platform_TeleporterDevA.h"
...
EntityTemplate* Templates_Platform_TeleporterDevA::GetNew() {
    EntityTemplate* t = EntityTemplatesList::newEntry("Platform_TeleporterDevA");
...
Drawable3DCreateConfig_VoxelGrid* Templates_Platform_TeleporterDevA::buildBase() {
