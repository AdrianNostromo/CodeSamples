#include "ContentZoneTurnBasedRDungeonA.h"
...
std::string ContentZoneTurnBasedRDungeonA::NAME = "TurnBasedRDungeonA";

bool ContentZoneTurnBasedRDungeonA::IS_DEBUG_VIEW_LOG = true;

std::shared_ptr<worldGame3D::ContentZone> ContentZoneTurnBasedRDungeonA::FactoryFunction() {
	std::shared_ptr<worldGame3D::ContentZone> ret = std::make_shared<ContentZoneTurnBasedRDungeonA>();

	return ret;
}

ContentZoneTurnBasedRDungeonA::ContentZoneTurnBasedRDungeonA()
	: super(NAME)
{
	//void
}

void ContentZoneTurnBasedRDungeonA::onZoneActivated(std::shared_ptr<worldGame3D::ZoneStartExtraData>& zoneStartExtraData, base::IGameWorld* gw) {
...
void ContentZoneTurnBasedRDungeonA::onZoneDeactivate_pre(base::IGameWorld* gw) {
