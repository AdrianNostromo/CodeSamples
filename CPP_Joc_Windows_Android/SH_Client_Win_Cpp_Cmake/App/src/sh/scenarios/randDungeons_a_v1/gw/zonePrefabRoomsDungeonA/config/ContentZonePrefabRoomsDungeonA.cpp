#include "ContentZonePrefabRoomsDungeonA.h"
...
std::string ContentZonePrefabRoomsDungeonA::NAME = "PrefabRoomsDungeonA";

bool ContentZonePrefabRoomsDungeonA::IS_DEBUG_VIEW_LOG = true;

std::shared_ptr<worldGame3D::ContentZone> ContentZonePrefabRoomsDungeonA::FactoryFunction() {
	std::shared_ptr<worldGame3D::ContentZone> ret = std::make_shared<ContentZonePrefabRoomsDungeonA>();

	return ret;
}

ContentZonePrefabRoomsDungeonA::ContentZonePrefabRoomsDungeonA()
	: super(NAME)
{
	//void
}

void ContentZonePrefabRoomsDungeonA::onZoneActivated(std::shared_ptr<worldGame3D::ZoneStartExtraData>& zoneStartExtraData, base::IGameWorld* gw) {
...
void ContentZonePrefabRoomsDungeonA::onZoneDeactivate_pre(base::IGameWorld* gw) {
