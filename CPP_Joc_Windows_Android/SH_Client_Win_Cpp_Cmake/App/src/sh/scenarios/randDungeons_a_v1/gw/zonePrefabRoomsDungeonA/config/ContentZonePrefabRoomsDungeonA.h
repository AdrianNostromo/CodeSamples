...
class ContentZonePrefabRoomsDungeonA : public common::ContentZoneCommon {priv typedef common::ContentZoneCommon super;pub dCtor(ContentZonePrefabRoomsDungeonA);
    ...
    pub explicit ContentZonePrefabRoomsDungeonA();
    ...
    pub ~ContentZonePrefabRoomsDungeonA() override;
};
};
};
