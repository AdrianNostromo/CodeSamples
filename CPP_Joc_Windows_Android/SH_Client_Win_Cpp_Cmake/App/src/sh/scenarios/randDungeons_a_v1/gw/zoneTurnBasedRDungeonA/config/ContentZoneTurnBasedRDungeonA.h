...
class ContentZoneTurnBasedRDungeonA : public common::ContentZoneCommon {priv typedef common::ContentZoneCommon super;pub dCtor(ContentZoneTurnBasedRDungeonA);
    ...
    pub explicit ContentZoneTurnBasedRDungeonA();
    ...
    pub ~ContentZoneTurnBasedRDungeonA() override;
};
};
};
