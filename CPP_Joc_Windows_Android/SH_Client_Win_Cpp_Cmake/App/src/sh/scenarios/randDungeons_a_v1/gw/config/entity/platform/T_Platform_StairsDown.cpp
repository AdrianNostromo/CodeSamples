#include "T_Platform_StairsDown.h"
...
std::string T_Platform_StairsDown::ID = "Platform_StairsDown";

EntityTemplate* T_Platform_StairsDown::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_Platform_StairsDown::buildBase() {
	Vector3Int gSize{ 6, 6, 2 };
