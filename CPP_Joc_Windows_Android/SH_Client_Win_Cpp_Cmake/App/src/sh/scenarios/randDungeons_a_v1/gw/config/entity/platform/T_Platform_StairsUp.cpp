...
std::string T_Platform_StairsUp::ID = "Platform_StairsUp";

EntityTemplate* T_Platform_StairsUp::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_Platform_StairsUp::buildBase() {
	Vector3Int gSize{ 6, 6, 6 };
