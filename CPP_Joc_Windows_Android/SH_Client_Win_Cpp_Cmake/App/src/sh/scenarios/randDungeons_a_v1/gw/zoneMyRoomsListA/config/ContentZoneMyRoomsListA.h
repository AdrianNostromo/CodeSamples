...
namespace MyRoomsListA {
class ContentZoneMyRoomsListA : public common::ContentZoneCommon {priv typedef common::ContentZoneCommon super;pub dCtor(ContentZoneMyRoomsListA);
	pub static std::string NAME;
	pub static std::shared_ptr<worldGame3D::ContentZone> FactoryFunction();
	
    pub explicit ContentZoneMyRoomsListA();
    ...
    pub ~ContentZoneMyRoomsListA() override;
};
};
};
