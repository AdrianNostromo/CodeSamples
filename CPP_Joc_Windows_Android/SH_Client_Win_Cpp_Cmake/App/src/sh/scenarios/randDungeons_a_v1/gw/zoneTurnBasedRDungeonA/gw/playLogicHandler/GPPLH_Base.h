...
class GPPLH_Base : public GamePart, virtual public IGamePartPlayLogicHandler {priv typedef GamePart super;pub dCtor(GPPLH_Base);
	priv std::shared_ptr< TurnBasedRDungeonA::DungeonContent> dungeonContent = nullptr;
	...
	prot std::shared_ptr< TurnBasedRDungeonA::DungeonContent> getDungeonContent();
	...
	pub void setData(
		std::shared_ptr< TurnBasedRDungeonA::DungeonContent> dungeonContent,
