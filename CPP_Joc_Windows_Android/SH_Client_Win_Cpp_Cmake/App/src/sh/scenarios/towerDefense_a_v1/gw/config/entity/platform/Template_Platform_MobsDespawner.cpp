#include "Template_Platform_MobsDespawner.h"
...
std::string Template_Platform_MobsDespawner::ID = "Platform_MobsDespawner";

EntityTemplate* Template_Platform_MobsDespawner::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* Template_Platform_MobsDespawner::buildBase() {
