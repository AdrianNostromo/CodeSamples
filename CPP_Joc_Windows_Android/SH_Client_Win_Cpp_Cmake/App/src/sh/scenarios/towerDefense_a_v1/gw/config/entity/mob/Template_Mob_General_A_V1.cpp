...
std::string Template_Mob_General_A_V1::ID = "Mob_General_A_V1";

EntityTemplate* Template_Mob_General_A_V1::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
    ...
    movingEntity->pushMovementConfig(new rpg3D::MovementConfigPhysicsPush(
        40.0f/*moveForce*/, 0.9995/*moveDamping*/,
