#include "Template_Turret_CubesCannon_B_V1.h"
...
std::string Template_Turret_CubesCannon_B_V1::ID = "Turret_CubesCannon_B_V1";

EntityTemplate* Template_Turret_CubesCannon_B_V1::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* Template_Turret_CubesCannon_B_V1::buildBase() {
