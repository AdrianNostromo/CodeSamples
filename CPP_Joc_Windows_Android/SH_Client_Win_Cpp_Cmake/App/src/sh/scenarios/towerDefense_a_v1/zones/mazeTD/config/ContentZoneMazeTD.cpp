...
std::string ContentZoneMazeTD::NAME = "MazeTD";

std::shared_ptr<worldGame3D::ContentZone> ContentZoneMazeTD::FactoryFunction() {
	std::shared_ptr<worldGame3D::ContentZone> ret = std::make_shared<ContentZoneMazeTD>();

	return ret;
}

ContentZoneMazeTD::ContentZoneMazeTD()
	: super(NAME)
{
	//void
}

int ContentZoneMazeTD::getMainUIViewID() {
	return IMainInGameUIView::ID;
}

rpg3D::MainInGameUIView* ContentZoneMazeTD::getNewMainUIViewUninitialised(base::IGameWorld* gw) {
	MainInGameUIView* ret = new MainInGameUIView(gw->getHandler()->getApp(), gw);

	return ret;
}

void ContentZoneMazeTD::onZoneActivated(std::shared_ptr<worldGame3D::ZoneStartExtraData>& zoneStartExtraData, base::IGameWorld* gw) {
	...
	Array2D<int> elementsGrid(
		...
		new int[25 * 17] {
			...
			O,O,O,O,O,W,W,W,W,W,W,W,W,W,W,W,W,W,W,W,O,O,O,O,O,
			O,O,O,O,O,W,W,W,W,W,W,W,W,W,W,W,W,W,W,W,O,O,O,O,O,
			O,O,O,O,O,W,W,T,T,T,T,T,T,T,T,T,T,T,W,W,O,O,O,O,O,
			O,O,O,O,O,W,W,T,T,T,T,T,T,T,T,T,T,T,W,W,O,O,O,O,O,
			O,O,O,O,O,W,W,T,T,T,T,T,T,T,T,T,T,T,W,W,O,O,O,O,O,
			O,O,O,O,O,W,W,T,T,T,T,T,T,T,T,T,T,T,W,W,O,O,O,O,O,
			O,O,O,O,O,W,W,T,T,T,T,T,T,T,T,T,T,T,W,W,O,O,O,O,O,
...
void ContentZoneMazeTD::onZoneDeactivate_pre(base::IGameWorld* gw) {
	super::onZoneDeactivate_pre(gw);

	gw->disposeGamePart<IGamePartPlayLogicHandler*>();
}

void ContentZoneMazeTD::createGroundPatch(
...
void ContentZoneMazeTD::createConfigEntity(
	float x, float y, float z,
	float rotZ,
	EntityTemplate* entityTemplate,
