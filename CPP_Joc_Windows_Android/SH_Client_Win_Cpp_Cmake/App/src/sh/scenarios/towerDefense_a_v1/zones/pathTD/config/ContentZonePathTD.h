...
namespace PathTD {
class ContentZonePathTD : public rpg3D::ContentZone {priv typedef rpg3D::ContentZone super;pub dCtor(ContentZonePathTD);
	pub static std::string NAME;
	pub static std::shared_ptr<worldGame3D::ContentZone> FactoryFunction();

	pub explicit ContentZonePathTD();
    ...
    pub ~ContentZonePathTD() override;
};
};
};
