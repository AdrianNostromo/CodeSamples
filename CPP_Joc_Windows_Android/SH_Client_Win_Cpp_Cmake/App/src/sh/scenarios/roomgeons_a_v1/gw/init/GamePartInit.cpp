...
void GamePartInit::createPlayerUnit(float x, float y, float z) {
	...
	IWorldEntity* entity = gw->getGPMain()->createEntity(
		...
		rpg3D::EntityIds::playerUnit/*instanceId*/, 0/*ownerPlayerId*/,
		extraData,
		...
		[this](IWorldEntity* entity) -> void {
			...
			mob_team->setTeamIndex(rpg3D::TeamsIndexesList::PLAYER_UNIT);
			...
			entity->getComponentAs<rpg3D::ILivingEntityModule*>(true/*mustExist*/)
				->setRemoveEntityFromGWOnZeroHp(false);
		}, false/*isActive*//*the entity is activated by the zone start*/
	);

	sp<ArrayList<std::shared_ptr<rpg3D::EffectPayload>>> melleToolsPayloadsList{new ArrayList<std::shared_ptr<rpg3D::EffectPayload>>()};
	melleToolsPayloadsList->appendDirect(std::make_shared<rpg3D::EffectPayload>(rpg3D::EffectPayload::Types::physicalDamage, rpg3D::EffectPayload::Target::OTHER_ENTITY, 1.0f));

	ArrayList<ToolCreationInfo> toolCreationInfosList{};
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_Sword_Basic_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::Melle, melleToolsPayloadsList, nullptr/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_Mace_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::Melle, melleToolsPayloadsList, nullptr/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_Spear_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::Melle, melleToolsPayloadsList, nullptr/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_BallAndChain_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::Melle, melleToolsPayloadsList, nullptr/*projectileConfig*/);

	toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_Bow_Basic_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::InertialProjectile, nullptr/*melleToolPayloadsList*/, rpg3D::ProjectileConfigsList::Arrow_Basic_A_V1/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_Crossbow_Basic_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::InertialProjectile, nullptr/*melleToolPayloadsList*/, rpg3D::ProjectileConfigsList::Bolt_Basic_A_V1/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_AutomaticRifle_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::InertialProjectile, nullptr/*melleToolPayloadsList*/, rpg3D::ProjectileConfigsList::Bullet_Basic_A_V1/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_HandgunAutomatic_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::InertialProjectile, nullptr/*melleToolPayloadsList*/, rpg3D::ProjectileConfigsList::Bullet_Basic_A_V1/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_HandgunManual_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::InertialProjectile, nullptr/*melleToolPayloadsList*/, rpg3D::ProjectileConfigsList::Bullet_Basic_A_V1/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_LaserGun_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::InertialProjectile, nullptr/*melleToolPayloadsList*/, rpg3D::ProjectileConfigsList::LaserSegment_Basic_A_V1/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_Shotgun_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::InertialProjectile, nullptr/*melleToolPayloadsList*/, rpg3D::ProjectileConfigsList::Bullet_Basic_A_V1/*projectileConfig*/);
	//toolCreationInfosList.append_emplace(rpg3D::Cfg_Tool_SubMachineGun_A_V1::getOrCreateTemplate()->id, ToolCreationInfo::ToolType::InertialProjectile, nullptr/*melleToolPayloadsList*/, rpg3D::ProjectileConfigsList::Bullet_Basic_A_V1/*projectileConfig*/);

	rpg3D::IToolsHandlerModule* entity_toolsHandler = entity->getComponentAs<rpg3D::IToolsHandlerModule*>(true/*mustExist*/);
	for (int i = 0; i < toolCreationInfosList.count(); i++) {
		ToolCreationInfo& toolCreationInfo = toolCreationInfosList.getReference(i);

		rpg3D::ToolConfigBase* toolConfig = rpg3D::ToolConfigBase::FromId(toolCreationInfo.configId, true/*mustExist*/);

		sp<rpg3D::Tool> tool = nullptr;
		if (toolCreationInfo.toolType == ToolCreationInfo::ToolType::Melle) {
			tool = toolConfig->createNewTool(
				gw->getAppAssets()
			);
			sp<rpg3D::ToolMelleArea> cTool = tool.dCast<rpg3D::ToolMelleArea>(true/*mustExtend*/);
			if (toolCreationInfo.melleToolsPayloadsList == nullptr) {
				throw LogicException(LOC);
			}
			cTool->addPayloadsList(toolCreationInfo.melleToolsPayloadsList.get());

			entity_toolsHandler->addTool(
				cTool
			);
		}else if (toolCreationInfo.toolType == ToolCreationInfo::ToolType::InertialProjectile) {
			tool = toolConfig->createNewTool(
				gw->getAppAssets()
			);
			sp<rpg3D::ToolRangeInertialProjectile> cTool = tool.dCast<rpg3D::ToolRangeInertialProjectile>(true/*mustExtend*/);
			if (toolCreationInfo.projectileConfig == nullptr) {
				throw LogicException(LOC);
			}
			cTool->setProjectileConfig(toolCreationInfo.projectileConfig);
			entity_toolsHandler->addTool(
				cTool
			);
		} else {
