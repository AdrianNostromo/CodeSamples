#include "Template_Mob_General_A_V1.h"
...
#include <sh/scenarios/battlezones_a_v1/config/sounds/SoundConfigsList.h>
...
EntityTemplate* Template_Mob_General_A_V1::getNew() {
    EntityTemplate* t = EntityTemplatesList::newEntry("Mob_General_A_V1");

	t->tagsList.appendReference(EntityTags::UNIT);
	t->tagsList.appendReference(EntityTags::MOB);
...
Drawable3DCreateConfig_VoxelGrid* Template_Mob_General_A_V1::buildBase() {
    // Unused
