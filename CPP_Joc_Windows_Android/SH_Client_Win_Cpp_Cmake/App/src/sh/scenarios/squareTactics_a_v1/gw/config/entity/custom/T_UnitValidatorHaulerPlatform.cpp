#include "T_UnitValidatorHaulerPlatform.h"
...
std::string T_UnitValidatorHaulerPlatform::ID = "T_UnitValidatorHaulerPlatform";

EntityTemplate* T_UnitValidatorHaulerPlatform::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_UnitValidatorHaulerPlatform::buildBase() {
