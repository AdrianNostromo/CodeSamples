#include "T_PlatformSlimeTeleporter.h"
...
std::string T_PlatformSlimeTeleporter::ID = "T_PlatformSlimeTeleporter";

EntityTemplate* T_PlatformSlimeTeleporter::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_PlatformSlimeTeleporter::buildBase() {
