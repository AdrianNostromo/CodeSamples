...
#include <sh/scenarios/customRoomgeons/gw/config/entity/custom/T_UnitValidatorHaulerPlatform.h>
#include <sh/scenarios/customRoomgeons/gw/config/entity/platform/T_PlatformSlimeTeleporter.h>
#include <sh/scenarios/customRoomgeons/gw/config/entity/environment/T_Doorframe_A_V1.h>
#include <sh/scenarios/customRoomgeons/gw/config/entity/environment/T_Pillar_A_V1.h>
#include <sh/scenarios/customRoomgeons/gw/config/entity/environment/T_WallElement_A_V1.h>
...
using namespace customRoomgeons::czDefenseTownA;
	...
	: super(NAME, true/*useAutoPlayerPositioning*/, EntityIds::defaultZoneEntrance/*defaultZoneEntrance*/)
{
	...
	if (customRoomgeons::T_PlatformSlimeTeleporter::TEMPLATE == nullptr) {
		throw LogicException(LOC);
	}
	(void)customRoomgeons::T_UnitValidatorHaulerPlatform::TEMPLATE;
	(void)customRoomgeons::T_Doorframe_A_V1::TEMPLATE;
	(void)customRoomgeons::T_Pillar_A_V1::TEMPLATE;
	(void)customRoomgeons::T_WallElement_A_V1::TEMPLATE;
}
