...
#include <rpg3D/gw/entity/module/toolsHandler/tool/playerUnit/moveTurnGridTurnBased/ToolMTGridTurnBased.h>
#include <rpg3D/gw/entity/module/toolsHandler/tool/playerUnit/moveGlobalDirection/ToolMGlobalDirection.h>
...
#include <rpg3D/gw/entity/module/controller/logicBlock/playerUnit/gridTurnBasedActiveTools/LBGridTurnBasedActiveTools.h>
...
void GamePartInit::onGWEvent_createContent(IEventListener& eventListener, base::GWEvent& event) {
	...
	{
		Vector3 offsetDir{ 0.0f, 0.0f, 1.0f };
		offsetDir.nor();
...
void GamePartInit::createPlayerUnit(float x, float y, float z) {
	...
	IWorldEntity* entity = gw->getGPMain()->createEntity(
		...
		[this](IWorldEntity* entity) -> void {
			...
			entity_toolsHandler->addTool(msp<rpg3D::playerUnit::ToolMTGridTurnBased>(), gw->getAppAssets()->getEmbeddedAssetsManager());
			...
			rpg3D::playerUnit::LBGridTurnBasedActiveTools* lBGridTurnBasedActiveTools = new rpg3D::playerUnit::LBGridTurnBasedActiveTools();
			entity_controller->registerLogicBlock(lBGridTurnBasedActiveTools, rpg3D::playerUnit::ILBGridTurnBasedActiveTools::ID, static_cast<rpg3D::playerUnit::ILBGridTurnBasedActiveTools*>(lBGridTurnBasedActiveTools));
...

	{
		...
		sp<rpg3D::Tool> toolSword = rpg3D::Cfg_Tool_Sword_Basic_A_V1::getOrCreateTemplate()->createNewTool(
			gw->getAppAssets()
		);
		sp<rpg3D::ToolMelleArea> cToolSword = toolSword.dCast<rpg3D::ToolMelleArea>(true/*mustExtend*/);
		cToolSword->addPayload(std::make_shared<rpg3D::EffectPayload>(rpg3D::EffectPayload::Types::physicalDamage, rpg3D::EffectPayload::Target::OTHER_ENTITY, 1.0f));
	...
	{
		rpg3D::IToolsHandlerModule* entity_toolsHandler = entity->getComponentAs<rpg3D::IToolsHandlerModule*>(true/*mustExist*/);
		sp<rpg3D::Tool> toolBow = rpg3D::Cfg_Tool_Bow_Basic_A_V1::getOrCreateTemplate()->createNewTool(
			gw->getAppAssets()
		);
		sp<rpg3D::ToolRangeInertialProjectile> cToolBow = toolBow.dCast<rpg3D::ToolRangeInertialProjectile>(true/*mustExtend*/);
		cToolBow->setProjectileConfig(rpg3D::ProjectileConfigsList::Arrow_Basic_Grid06Range3Tiles_A_V1);
		entity_toolsHandler->addTool(
			cToolBow
		);
