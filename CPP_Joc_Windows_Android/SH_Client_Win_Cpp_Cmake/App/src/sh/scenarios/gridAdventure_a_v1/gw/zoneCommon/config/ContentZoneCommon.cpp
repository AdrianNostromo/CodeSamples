...
#include <sh/scenarios/gridAdventure_a_v1/gw/playerZeroHpHandling/IGPPlayerZeroHpHandling.h>
#include "../../zoneMain/config/ContentZoneMain.h"

using namespace gridAdventure_a_v1;
using namespace gridAdventure_a_v1::common;
...
void ContentZoneCommon::onZoneActivated(std::shared_ptr<worldGame3D::ZoneStartExtraData>& zoneStartExtraData, base::IGameWorld* gw) {
	...
	ZoneStartExtraData* cZoneStartExtraData = nullptr;
