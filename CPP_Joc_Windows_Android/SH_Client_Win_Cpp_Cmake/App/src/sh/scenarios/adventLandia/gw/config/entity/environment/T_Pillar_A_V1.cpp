...
std::string T_Pillar_A_V1::ID = "T_Pillar_A_V1";

EntityTemplate* T_Pillar_A_V1::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
	...
	physics3D->pBodiesConfigsList.append_emplace_chain(
		...
		new physics3D::PhysicsShapeConfigBox(
            ...
            Vector3{0.1f, 0.1f, 0.3f}/*halfExtents*/
		),
...
Drawable3DCreateConfig_VoxelGrid* T_Pillar_A_V1::buildBase() {
	Vector3Int gSize{ 4, 4, 7 };
