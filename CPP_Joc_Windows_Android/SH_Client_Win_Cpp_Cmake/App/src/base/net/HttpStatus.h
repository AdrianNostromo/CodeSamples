...
public:
    ...
    // not used
    // static const int SC_UNPROCESSABLE_ENTITY = 418;
...
public:
    ...
    HttpStatus& operator=(HttpStatus const&) = delete;
    HttpStatus& operator=(HttpStatus &&) = default;

    explicit HttpStatus(int statusCode);
