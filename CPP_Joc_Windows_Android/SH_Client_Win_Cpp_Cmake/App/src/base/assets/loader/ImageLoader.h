...
class ImageLoader : public BasicAssetLoader {priv typedef BasicAssetLoader super;pub dCtor(ImageLoader);
    ...
    priv base::Image* data = nullptr;

    pub explicit ImageLoader(
