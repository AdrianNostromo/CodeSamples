...
ArrayList<MenuItemConfig*>* EntityEditorView::viewItemConfigs = base::StaticsInit::AddCbGeneral<ArrayList<MenuItemConfig*>*>(1, []() {
	viewItemConfigs = (new ArrayList<MenuItemConfig*>())
		...
		->appendDirect_chain(new_viewItemConfig_bottomArea())
		->appendDirect_chain(new_viewItemConfig_settingsDrawerA());
});

ArrayList<StateChangeDurations*>* EntityEditorView::viewAnimationDurations = base::StaticsInit::AddCbGeneral<ArrayList<StateChangeDurations*>*>(1, []() {
