...
namespace rpg3D {
class ZoneEditorTemplate : public BasicModuleTemplate {priv typedef BasicModuleTemplate super;pub dCtor(ZoneEditorTemplate);
    pub explicit ZoneEditorTemplate();
    ...
    pub ~ZoneEditorTemplate() override;
};
};
