...
namespace rpg3D {
class VoxelizedEditorTemplate : public BasicModuleTemplate {priv typedef BasicModuleTemplate super;pub dCtor(VoxelizedEditorTemplate);
    pub explicit VoxelizedEditorTemplate();
    ...
    pub ~VoxelizedEditorTemplate() override;
};
};
