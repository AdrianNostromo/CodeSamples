...
namespace rpg3D {
class ToolConfigZESun : public ToolConfigZoneEditor {priv typedef ToolConfigZoneEditor super;pub dCtor(ToolConfigZESun);
    pub static std::string TAG_zeSun;

	pub explicit ToolConfigZESun(
		std::string id,
		int filtersPriority,
