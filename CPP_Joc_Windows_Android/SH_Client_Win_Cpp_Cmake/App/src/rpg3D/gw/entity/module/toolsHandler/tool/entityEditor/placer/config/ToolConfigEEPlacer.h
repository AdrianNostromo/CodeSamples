...
namespace rpg3D {
class ToolConfigEEPlacer : public ToolConfigEntityEditor {priv typedef ToolConfigEntityEditor super;pub dCtor(ToolConfigEEPlacer);
    pub static std::string TAG_eePlacer;

	pub explicit ToolConfigEEPlacer(
		std::string id,
		int filtersPriority,
    ...
    pub ~ToolConfigEEPlacer() override;
};
};
