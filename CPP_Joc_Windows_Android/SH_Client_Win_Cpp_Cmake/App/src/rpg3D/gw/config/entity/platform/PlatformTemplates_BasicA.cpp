#include "PlatformTemplates_BasicA.h"
...
EntityTemplate* PlatformTemplates_BasicA::getNew() {
    EntityTemplate* t = EntityTemplatesList::newEntry("Platform_BasicA");
...
Drawable3DCreateConfig_VoxelGrid* PlatformTemplates_BasicA::buildBase() {
