#include "T_Item_DamageHearth_A_V1.h"
...
std::string T_Item_DamageHearth_A_V1::ID = "Item_DamageHearth_A_V1";

const float T_Item_DamageHearth_A_V1::GROUND_PLACEMENT_OFFSET_Z = 0.175f;

EntityTemplate* T_Item_DamageHearth_A_V1::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
	...
	physics3D->pBodiesConfigsList.append_emplace_chain(
		...
		new physics3D::PhysicsShapeConfigBox(
            ...
            Vector3{0.025f, 0.1f, 0.175f}/*halfExtents*/
		),
...
Drawable3DCreateConfig_VoxelGrid* T_Item_DamageHearth_A_V1::buildBase() {
    Vector3Int gSize{ 1, 7, 7 };
