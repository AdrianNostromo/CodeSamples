...
std::string T_StoneRock_A_V1::ID = "StoneRock_A_V1";

EntityTemplate* T_StoneRock_A_V1::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
	...
	physics3D->pBodiesConfigsList.append_emplace_chain(
        ...
        new Vector3{ 0.0f, 0.0f, 0.14f }/*physicsBodyOffsetPos*/, nullptr/*physicsBodyOffsetRot*/,
		new physics3D::PhysicsShapeConfigBox(
            rpg3D::PhysicsUtil::DEFAULT_COLLISSION_MARGIN/*collisionMargin*/,
            Vector3{0.25f, 0.25f, 0.14f}/*halfExtents*/
		),
...
Drawable3DCreateConfig_VoxelGrid* T_StoneRock_A_V1::buildBase() {
	Vector3Int gSize{ 5, 5, 3 };
