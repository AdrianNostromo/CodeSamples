#include "T_Platform_NextUpSmall.h"
...
std::string T_Platform_NextUpSmall::ID = "Platform_NextUpSmall";

EntityTemplate* T_Platform_NextUpSmall::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_Platform_NextUpSmall::buildBase() {
