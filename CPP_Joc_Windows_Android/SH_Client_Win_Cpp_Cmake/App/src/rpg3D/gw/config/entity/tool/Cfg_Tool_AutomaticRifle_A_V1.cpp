#include "Cfg_Tool_AutomaticRifle_A_V1.h"
...
ToolConfigBase* Cfg_Tool_AutomaticRifle_A_V1::getOrCreateTemplate() {
	std::string id = "Tool_AutomaticRifle_A_V1";
	...
	rpg3D::ToolConfigRangeInertialProjectile* cT = new rpg3D::ToolConfigRangeInertialProjectile(
		...
		std::make_shared<std::string>("visual2D/taGeneral.atlas"), std::make_shared<std::string>("sh/tools/weapons/automaticRifle_A_V1"),
		"AutomaticRifle"/*shortName_partA*/, ""/*shortName_partB*/,
		0.3f/*cooldownS*/, 0.0f/*channelingDurationS*/,
...
Drawable3DCreateConfig_VoxelGrid* Cfg_Tool_AutomaticRifle_A_V1::buildBase() {
