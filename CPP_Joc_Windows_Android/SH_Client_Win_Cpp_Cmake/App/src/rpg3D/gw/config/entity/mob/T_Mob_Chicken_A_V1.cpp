...
std::string T_Mob_Chicken_A_V1::ID = "Mob_Chicken_A_V1";

EntityTemplate* T_Mob_Chicken_A_V1::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_Mob_Chicken_A_V1::buildBase() {
