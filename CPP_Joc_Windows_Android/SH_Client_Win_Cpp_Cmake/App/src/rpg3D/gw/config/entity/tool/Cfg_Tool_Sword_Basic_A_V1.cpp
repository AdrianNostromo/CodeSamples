#include "Cfg_Tool_Sword_Basic_A_V1.h"
...
ToolConfigBase* Cfg_Tool_Sword_Basic_A_V1::getOrCreateTemplate() {
	std::string id = "Tool_Sword_Basic_A_V1";
	...
	t = new rpg3D::ToolConfigMelleArea(
        "Tool_Sword_Basic_A_V1",
		rpg3D::ToolConfigBase::FiltersPriority::manual/*filtersPriority*/,
		true/*supportsContinuousReactivation*/,
		std::make_shared<std::string>("visual2D/taGeneral.atlas"), std::make_shared<std::string>("sh/tools/weapons/sword_Basic_A_V1"),
		"Sword"/*shortName_partA*/, ""/*shortName_partB*/,
...
Drawable3DCreateConfig_VoxelGrid* Cfg_Tool_Sword_Basic_A_V1::buildBase() {
