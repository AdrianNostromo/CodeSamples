#include "Cfg_Tool_Shotgun_A_V1.h"
...
ToolConfigBase* Cfg_Tool_Shotgun_A_V1::getOrCreateTemplate() {
	std::string id = "Tool_Shotgun_A_V1";
	...
	rpg3D::ToolConfigRangeInertialProjectile* cT = new rpg3D::ToolConfigRangeInertialProjectile(
		...
		std::make_shared<std::string>("visual2D/taGeneral.atlas"), std::make_shared<std::string>("sh/tools/weapons/shotgun_A_V1"),
		"Shotgun"/*shortName_partA*/, ""/*shortName_partB*/,
        0.75f/*cooldownS*/, 0.0f/*channelingDurationS*/,
		0.2f/*projectileLaunchPhysicsImpulse*/,
		nullptr/*projectilePreviewParent*/,
	...
	cT->projectileSpawnConfigsList.append_emplace("_projectileSpawnParent_"/*projectileSpawnParentId*/, -10.0f/*spawnAngZDeg*/, 4.0f/*maxSpawnAngZDegError*/);
	cT->projectileSpawnConfigsList.append_emplace("_projectileSpawnParent_"/*projectileSpawnParentId*/, 0.0f/*spawnAngZDeg*/, 4.0f/*maxSpawnAngZDegError*/);
	cT->projectileSpawnConfigsList.append_emplace("_projectileSpawnParent_"/*projectileSpawnParentId*/, 10.0f/*spawnAngZDeg*/, 4.0f/*maxSpawnAngZDegError*/);

	return cT;
}

Drawable3DCreateConfig_VoxelGrid* Cfg_Tool_Shotgun_A_V1::buildBase() {
