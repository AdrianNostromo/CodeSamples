...
ToolConfigBase* Cfg_Tool_Spear_A_V1::getOrCreateTemplate() {
	std::string id = "Tool_Spear_A_V1";
	...
	t = new rpg3D::ToolConfigMelleArea(
		...
		std::make_shared<std::string>("visual2D/taGeneral.atlas"), std::make_shared<std::string>("sh/tools/weapons/spear_A_V1"),
		"Spear"/*shortName_partA*/, ""/*shortName_partB*/,
...
Drawable3DCreateConfig_VoxelGrid* Cfg_Tool_Spear_A_V1::buildBase() {
