...
std::string T_Platform_E::ID = "Platform_E";

EntityTemplate* T_Platform_E::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_Platform_E::buildBase() {
