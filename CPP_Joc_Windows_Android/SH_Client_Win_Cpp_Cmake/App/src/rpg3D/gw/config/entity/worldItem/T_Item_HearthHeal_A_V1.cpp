#include "T_Item_HearthHeal_A_V1.h"
...
std::string T_Item_HearthHeal_A_V1::ID = "Item_HearthHeal_A_V1";

const float T_Item_HearthHeal_A_V1::GROUND_PLACEMENT_OFFSET_Z = 0.175f;

EntityTemplate* T_Item_HearthHeal_A_V1::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_Item_HearthHeal_A_V1::buildBase() {
