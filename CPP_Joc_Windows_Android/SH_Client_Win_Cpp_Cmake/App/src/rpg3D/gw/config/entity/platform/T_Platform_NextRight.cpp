#include "T_Platform_NextRight.h"
...
std::string T_Platform_NextRight::ID = "Platform_NextRight";

EntityTemplate* T_Platform_NextRight::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_Platform_NextRight::buildBase() {
