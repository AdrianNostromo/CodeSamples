#include "Cfg_Tool_HandgunManual_A_V1.h"
...
ToolConfigBase* Cfg_Tool_HandgunManual_A_V1::getOrCreateTemplate() {
	std::string id = "Tool_HandgunManual_A_V1";
	...
	rpg3D::ToolConfigRangeInertialProjectile* cT = new rpg3D::ToolConfigRangeInertialProjectile(
		...
		false/*supportsContinuousReactivation*/,
		std::make_shared<std::string>("visual2D/taGeneral.atlas"), std::make_shared<std::string>("sh/tools/weapons/handgunManual_A_V1"),
		"8 Shooter"/*shortName_partA*/, ""/*shortName_partB*/,
        0.2f/*cooldownS*/, 0.0f/*channelingDurationS*/,
...
Drawable3DCreateConfig_VoxelGrid* Cfg_Tool_HandgunManual_A_V1::buildBase() {
