#include "Cfg_Tool_LaserGun_A_V1.h"
...
ToolConfigBase* Cfg_Tool_LaserGun_A_V1::getOrCreateTemplate() {
	std::string id = "Tool_LaserGun_A_V1";
	...
	rpg3D::ToolConfigRangeInertialProjectile* cT = new rpg3D::ToolConfigRangeInertialProjectile(
		...
		std::make_shared<std::string>("visual2D/taGeneral.atlas"), std::make_shared<std::string>("sh/tools/weapons/laserGun_A_V1"),
		"Laser Gun"/*shortName_partA*/, ""/*shortName_partB*/,
...
Drawable3DCreateConfig_VoxelGrid* Cfg_Tool_LaserGun_A_V1::buildBase() {
