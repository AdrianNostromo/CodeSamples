#include "TC_BrokenTeleporterPlatform_Up.h"
...
EntityTemplate* TC_BrokenTeleporterPlatform_Up::getOrCreateTemplate(unsigned int voxelSizeCM) {
    std::string templateBakedId = "C_BrokenTeleporterPlatform_Up_#voxelSizeCM#";
...
Drawable3DCreateConfig_VoxelGrid* TC_BrokenTeleporterPlatform_Up::buildBase(unsigned int voxelSizeCM) {
