#include "GroundTemplates_BasicPatchA_6dm.h"
...
EntityTemplate* GroundTemplates_BasicPatchA_6dm::getNew() {
	EntityTemplate* t = EntityTemplatesList::newEntry("Ground_BasicPatchA_6dm");
	...
	physics3D->pBodiesConfigsList.append_emplace_chain(
		...
		new Vector3{ 0.3f, 0.3f, -0.05f }/*physicsBodyOffsetPos*/, nullptr/*physicsBodyOffsetRot*/,
		new physics3D::PhysicsShapeConfigBox(
			CM/*collisionMargin*/,
			Vector3{ 0.3f, 0.3f, 0.05f - CM }/*halfExtents*/
		),
