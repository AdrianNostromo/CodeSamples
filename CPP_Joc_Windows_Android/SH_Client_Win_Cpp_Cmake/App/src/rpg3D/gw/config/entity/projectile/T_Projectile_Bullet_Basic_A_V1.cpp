...
#include "T_Projectile_Bullet_Basic_A_V1.h"
...
EntityTemplate* T_Projectile_Bullet_Basic_A_V1::getOrCreateTemplate() {
    std::string templateBakedId = "Projectile_Bullet_Basic_A_V1";
	...
	physics3D->pBodiesConfigsList.append_emplace_chain(
        ...
        new physics3D::PhysicsShapeConfigConvexHull(
            ...
            new physics3D::PhysicsShapeConfigConvexHull::Vec3[2]{
                {-0.1f * 0.03f - 0.04f + CM, 0.0f, 0.0f}, {0.1f * 0.03f + 0.04f - CM, 0.0f, 0.0f}
            }
        ),
...
Drawable3DCreateConfig_VoxelGrid* T_Projectile_Bullet_Basic_A_V1::buildBase() {
