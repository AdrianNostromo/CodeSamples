...
#include "T_Projectile_Arrow_Basic_A_V1.h"
...
EntityTemplate* T_Projectile_Arrow_Basic_A_V1::getOrCreateTemplate() {
    std::string templateBakedId = "Projectile_Arrow_Basic_A_V1";
...
Drawable3DCreateConfig_VoxelGrid* T_Projectile_Arrow_Basic_A_V1::buildBase() {
