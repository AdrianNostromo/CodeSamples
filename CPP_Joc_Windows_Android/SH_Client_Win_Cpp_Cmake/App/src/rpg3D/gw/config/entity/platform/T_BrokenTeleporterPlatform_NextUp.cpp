#include "T_BrokenTeleporterPlatform_NextUp.h"
...
std::string T_BrokenTeleporterPlatform_NextUp::ID = "BrokenTeleporterPlatform_NextUp";

EntityTemplate* T_BrokenTeleporterPlatform_NextUp::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_BrokenTeleporterPlatform_NextUp::buildBase() {
