#include "EntityTemplates_Platform_Teleporter_HomeSmall.h"
...
EntityTemplate* EntityTemplates_Platform_Teleporter_HomeSmall::getNew() {
    EntityTemplate* t = EntityTemplatesList::newEntry("Platform_Teleporter_HomeSmall");
	...
	physics3D->pBodiesConfigsList.append_emplace_chain(
        ...
        new physics3D::PhysicsShapeConfigCylinder(
            CM/*collisionMargin*/,
            Vector3::Z, Vector3{ 0.12f, 0.12f, 0.05f }
        ),
...
Drawable3DCreateConfig_VoxelGrid* EntityTemplates_Platform_Teleporter_HomeSmall::buildBase() {
...
Drawable3DCreateConfig_VoxelGrid* EntityTemplates_Platform_Teleporter_HomeSmall::buildIcon() {
	const int gSizeX = 7;
	const int gSizeY = 7;
	const int gSizeZ = 1;
