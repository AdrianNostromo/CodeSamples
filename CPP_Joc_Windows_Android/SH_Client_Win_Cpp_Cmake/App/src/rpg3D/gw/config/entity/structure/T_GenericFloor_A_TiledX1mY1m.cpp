#include "T_GenericFloor_A_TiledX1mY1m.h"
...
std::string T_GenericFloor_A_TiledX1mY1m::ID = "GenericFloor_A_TiledX1mY1m";

std::string T_GenericFloor_A_TiledX1mY1m::DATA_KEY_materials = "_materials_";
Vector3Int T_GenericFloor_A_TiledX1mY1m::TileVoxelsCount{};

Array3D<signed char>* T_GenericFloor_A_TiledX1mY1m::gridStoneA = nullptr;
Array3D<signed char>* T_GenericFloor_A_TiledX1mY1m::gridStoneB = nullptr;
Array3D<signed char>* T_GenericFloor_A_TiledX1mY1m::gridGrassA = nullptr;
Array3D<signed char>* T_GenericFloor_A_TiledX1mY1m::gridGrassB = nullptr;
ArrayList<Visual3DModelMaterial*>* T_GenericFloor_A_TiledX1mY1m::materialsList = nullptr;

EntityTemplate* T_GenericFloor_A_TiledX1mY1m::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
	Vector3Int gSize{ 10, 10, 1 };
...
Drawable3DCreateConfig_VoxelGrid* T_GenericFloor_A_TiledX1mY1m::buildBase() {
