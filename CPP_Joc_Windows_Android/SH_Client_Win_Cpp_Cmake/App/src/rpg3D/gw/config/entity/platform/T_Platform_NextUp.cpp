...
std::string T_Platform_NextUp::ID = "Platform_NextUp";

EntityTemplate* T_Platform_NextUp::TEMPLATE = base::StaticsInit::AddCbGeneral<EntityTemplate*>(1, []() {
...
Drawable3DCreateConfig_VoxelGrid* T_Platform_NextUp::buildBase() {
