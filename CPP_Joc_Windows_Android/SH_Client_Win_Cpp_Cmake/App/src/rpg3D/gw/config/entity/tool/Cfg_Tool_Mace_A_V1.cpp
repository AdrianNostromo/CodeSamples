...
ToolConfigBase* Cfg_Tool_Mace_A_V1::getOrCreateTemplate() {
	std::string id = "Tool_Mace_A_V1";
	...
	t = new rpg3D::ToolConfigMelleArea(
		...
		std::make_shared<std::string>("visual2D/taGeneral.atlas"), std::make_shared<std::string>("sh/tools/weapons/mace_A_V1"),
		"Mace"/*shortName_partA*/, ""/*shortName_partB*/,
...
Drawable3DCreateConfig_VoxelGrid* Cfg_Tool_Mace_A_V1::buildBase() {
