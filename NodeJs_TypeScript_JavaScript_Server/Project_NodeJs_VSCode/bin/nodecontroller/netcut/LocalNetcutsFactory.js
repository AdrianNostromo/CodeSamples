...
const Netcut_CS_NodeController_To_ServerManager_1 = require("./../netcut/Netcut_CS_NodeController_To_ServerManager");
    ...
    constructor() {
        ...
        this.initEntries([
            ...
            new NetcutFactoryConfig_1.NetcutFactoryConfig(BasicNetcutsFactory_1.BasicNetcutsFactory.CONNECTION_TYPE_CLIENT, ComponentType_1.ComponentType.SERVER_MANAGER, function (app, con, componentType) {
                return new Netcut_CS_NodeController_To_ServerManager_1.Netcut_CS_NodeController_To_ServerManager(app, con, componentType);
            }.bind(this)),
            // As client.
