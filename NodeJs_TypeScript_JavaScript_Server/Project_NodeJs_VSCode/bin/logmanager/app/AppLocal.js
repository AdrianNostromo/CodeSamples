...
class AppLocal extends App_1.App {
    constructor(componentType, dirs) {
        super(componentType, dirs, new LocalNetcutsFactory_1.LocalNetcutsFactory(), new ClientListenerNetConfig_1.ClientListenerNetConfig(new IpPort_1.IpPort('127.0.0.1', 0)), new ServerConnectorNetConfig_1.ServerConnectorNetConfig());
    ...
    create_framework() {
        ...
        this.addComponent(this.logManager = new LogManager_1.LogManager(this.getApp()));
    }
}
