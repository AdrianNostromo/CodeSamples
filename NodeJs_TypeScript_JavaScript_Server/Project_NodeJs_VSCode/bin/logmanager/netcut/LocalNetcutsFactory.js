...
const Netcut_SC_LogManager_To_Component_1 = require("./Netcut_SC_LogManager_To_Component");
...
class LocalNetcutsFactory extends BasicNetcutsFactory_1.BasicNetcutsFactory {
    constructor() {
        ...
        this.initEntries([
            // As server.
            new NetcutFactoryConfig_1.NetcutFactoryConfig(BasicNetcutsFactory_1.BasicNetcutsFactory.CONNECTION_TYPE_SERVER, null, function (app, con, componentType) {
                return new Netcut_SC_LogManager_To_Component_1.Netcut_SC_LogManager_To_Component(app, con, componentType);
            }.bind(this)),
            // As client.
