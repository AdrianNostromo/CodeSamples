...
import { Netcut_CS_NodeController_To_ServerManager } from "./../netcut/Netcut_CS_NodeController_To_ServerManager";
    ...
    this.initEntries([
      ...
      new NetcutFactoryConfig(
        ...
        function(app: IApp, con: GeneralTcpConnection, componentType: ComponentType): Netcut_Component_To_Component {
          return new Netcut_CS_NodeController_To_ServerManager(<IAppLocal>app, con, componentType)
        }.bind(this)
      ),
      // As client.
      new NetcutFactoryConfig(
