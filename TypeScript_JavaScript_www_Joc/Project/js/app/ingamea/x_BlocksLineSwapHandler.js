...
define([
	...
	"use strict";
	return declare("app.ingamea.BlocksLineSwapHandler", ModuleBase, {
		moduleBranch: "inGame",
		...
		boundFunction_onBlockTouchStart: null,
		boundFunction_onBlockTouchEnd: null,
		boundFunction_onBlockTouchEndOutside: null,
		boundFunction_onBlockTouchMove: null,
		
		isBlockTouchActive: false,
		
		focusBlockIndice: -1,
		
		showFocusBox: false,
		focusBoxShowPercent: 0,
		focusBoxVisual: null,
		
		showFocusArrow: false,
		focusArrowShowPercent: 0,
		focusArrowVisual: null,
		...
		vConfig: {
			...
			swapTargetArrowLR: {
				visual: {
					type: "SPRITE",
					id: "inGame/misc/swapTargetArrowLR",
					anchor: {x: 0.5, y: 0.5},
			...
			swapTargetArrowL: {
				visual: {
					type: "SPRITE",
					id: "inGame/misc/swapTargetArrowL",
					anchor: {x: 0.5, y: 0.5},
					size: {width: 187, height: 84}
				}
			},
			swapTargetArrowR: {
				visual: {
					type: "SPRITE",
					id: "inGame/misc/swapTargetArrowR",
					anchor: {x: 0.5, y: 0.5},
					size: {width: 187, height: 84}
				}
			}
		...
		constructor: function() {
			this.boundFunction_onBlockTouchStart = this.onBlockTouchStart.bind(this);
			this.boundFunction_onBlockTouchEnd = this.onBlockTouchEnd.bind(this);
			this.boundFunction_onBlockTouchEndOutside = this.onBlockTouchEndOutside.bind(this);
			this.boundFunction_onBlockTouchMove = this.onBlockTouchMove.bind(this);
		},
		/*
