 ...
 */
 ...
 public class BitmapFontWriter {
	 ...
	 * page. The glyphs in BitmapFontData have a "page" fxId, which references the index of the pageRef you specify here.
	 * 
	 * The FontInfo parameter is useful for cleaner output; such as including a rendering3DSize and font face name hint. However, it can be
	...
	public static void writeFont (BitmapFontData fontData, String[] pageRefs, FileHandle outFntFile, FontInfo info, int scaleW, int scaleH) {
		...
		buf.append(xmlOpen)
			...
			.append("\" rendering3DSize=").append( quote(info.size) )
