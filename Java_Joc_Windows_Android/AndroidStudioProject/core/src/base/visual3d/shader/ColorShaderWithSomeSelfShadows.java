 ...
 */
public class ColorShaderWithSomeSelfShadows extends BasicShader {
    
	public ColorShaderWithSomeSelfShadows(final Renderable renderable, final ShaderProgram program) {
