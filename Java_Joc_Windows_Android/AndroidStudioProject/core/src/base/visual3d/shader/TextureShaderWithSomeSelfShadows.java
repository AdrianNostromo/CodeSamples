 ...
 */
public class TextureShaderWithSomeSelfShadows extends BasicShader {
    
	public TextureShaderWithSomeSelfShadows(final Renderable renderable, final ShaderProgram program) {
