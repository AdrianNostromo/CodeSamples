 ...
 */
public class x_SimpleTextureShader extends BaseShader {
	...
	public x_SimpleTextureShader(final Renderable renderable, final ShaderProgram shaderProgramModelBorder) {
